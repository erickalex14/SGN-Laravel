...
@push('css_adicional')
    <style>
        /* El bloque de CSS completo de modulo-empresas.php va aqui, sin alterar ni una coma */
...
@push('js_adicional')
    <script>
        // Mantienes exactamente las funciones mostrarMsgEmp, limpiarFormEmp, editarEmpresa, _esc...
