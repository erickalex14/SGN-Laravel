        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%;">Subtipo</th>
                    <th style="width: 24%;">Servicio / Técnico</th>
                    <th style="width: 12%; text-align: right;">Base Fija ($)</th>
                    <th style="width: 12%; text-align: right;">Mano de Obra (-50%)</th>
                    <th style="width: 12%; text-align: right;">Repuestos (100%)</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div style="font-size: 9.5px; color: #64748b;">
                                {{ $item->tecnico_nombre ?: 'Sin técnico' }}
