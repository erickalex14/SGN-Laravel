...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('ordenes') && !Schema::hasColumn('ordenes', 'memo_entrega')) {
            Schema::table('ordenes', function (Blueprint $table) {
                $table->text('memo_entrega')->nullable()->after('observacion');
            });
        }

        if (Schema::hasTable('ordenesempresas') && !Schema::hasColumn('ordenesempresas', 'memo_entrega')) {
            Schema::table('ordenesempresas', function (Blueprint $table) {
                $table->text('memo_entrega')->nullable()->after('descripcion');
            });
        }

        // Recrear vista_ordenes incluyendo memo_entrega
